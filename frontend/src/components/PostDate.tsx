      ...
      return (
        <Screen style={{ justifyContent: 'center', textAlign: 'center' }}>
          <div className="fu d1">
            ...
            <Btn ghost style={{ marginTop: 10 }} onClick={() => go('home')}>
              {copy.components.postDate.filed.backToday}
            </Btn>
          </div>
        </Screen>
      );
    ...
    return (
      <Screen key={step}>
        <div className="postdate-header">
          ...
          <button onClick={() => go('notes')} className="postdate-skip-btn">
        ...
        {step === 0 && (
          <div className="fu d1">
            ...
            <Btn disabled={!vibe} onClick={() => this.setStep(1)}>
              {copy.components.postDate.next}
            </Btn>
          </div>
        )}
