    ...
    return (
      <Screen className="home-screen">
        <div className="fu d1 home-header">
          ...
          <h2>
            {state.name
              ? copy.components.home.userGreeting.replace('{name}', state.name)
              : copy.components.home.defaultGreeting}
          </h2>
        </div>
        ...
        <div className="fu d2 home-confirmed-date-section">
          ...
          <div className="home-confirmed-date-card">
            ...
            <Mono className="home-venue-label">
              {copy.components.home.confirmedDate.venueLabel}
            </Mono>
            <p className="home-venue-info">Dimes · Essex St, LES</p>
            <Rule style={{ marginBottom: 12 }} />
            {/* Why you matched */}
            <div className="home-why-matched">
              <Mono className="home-why-matched-title">
                {copy.components.home.confirmedDate.whyMatched}
              </Mono>
              <p className="home-why-matched-text">
                You both value emotional availability and depth. Selin is also open to wherever it
                goes — same as you. Schedule overlap is 100% this week.
              </p>
            </div>
            <div className="home-schedule-indicator">
              <Mono className="home-schedule-text">
                {copy.components.home.confirmedDate.scheduleOverlapIndicator
                  .replace('{time}', '18')
                  .replace('{count}', '10')}
              </Mono>
        ...
        <div className="fu d4 home-pending-section">
          <div className="home-pending-header">
            ...
            <button onClick={() => go('matches')} className="home-see-all-button">
              {copy.components.home.waiting.seeAll}
            </button>
          </div>
