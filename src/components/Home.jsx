    ...
    return (
      <Screen style={{ paddingBottom:90 }}>
        ...
        <div className="fu d2" style={{ border:"1px solid var(--line)",padding:"13px 16px",background:"var(--bg1)",display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18 }}>
          <div>
            <Mono style={{ display:"block",marginBottom:4 }}>Your standing</Mono>
            <span style={{ fontFamily:"var(--serif)",fontSize:15,fontStyle:"italic",color:"var(--white)" }}>Good — all dates attended</span>
          </div>
          <Mono style={{ color:"var(--soft)",fontSize:8 }}>+2 bonus active</Mono>
        </div>

        {/* Confirmed date card */}
        <div className="fu d2" style={{ marginBottom:14 }}>
          <Mono style={{ display:"block",marginBottom:10 }}>Confirmed this week</Mono>
          <div style={{ border:"1px solid var(--line2)",background:"var(--bg1)",padding:"18px 16px" }}>
            ...
            <Mono style={{ display:"block",marginBottom:6 }}>Venue — confirmed</Mono>
            ...
            <div style={{ background:"var(--bg2)",padding:"10px 12px",marginBottom:12 }}>
              <Mono style={{ display:"block",marginBottom:6,fontSize:8 }}>Why you matched</Mono>
            ...
            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center" }}>
              <Mono style={{ fontSize:8 }}>Day-of chat unlocks in 18h · 10 messages</Mono>
        ...
        <div className="fu d3" onClick={()=>go("checkin")} style={{
          ...
          <div>
            <Mono style={{ display:"block",marginBottom:4,color:"var(--soft)" }}>Date window is open</Mono>
            <span style={{ fontFamily:"var(--serif)",fontSize:15,fontStyle:"italic",color:"var(--white)" }}>Check in when you arrive →</span>
          </div>
        ...
        <div className="fu d4" style={{ marginBottom:14 }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10 }}>
            <Mono>Waiting on you</Mono>
            <button onClick={()=>go("matches")} style={{ background:"none",border:"none",cursor:"pointer",fontFamily:"var(--mono)",fontSize:8,color:"var(--dim)",letterSpacing:"0.1em" }}>see all →</button>
          </div>
          {["Amara, 28 · 1.1 mi","Lily, 31 · 3.8 mi"].map((n,i)=>(
            <div key={i} onClick={()=>go("matches")} style={{
              ...
              <Mono style={{ fontSize:8 }}>respond →</Mono>
            </div>
          ))}
        </div>
        ...
        <div className="fu d5" onClick={()=>go("post-date")} style={{
          ...
          <Mono style={{ display:"block",marginBottom:5 }}>Field notes</Mono>
          <p style={{ fontFamily:"var(--serif)",fontSize:14,fontStyle:"italic",color:"var(--mid)",lineHeight:1.6 }}>How did Tuesday go? Write it down before the feeling fades.</p>
        </div>
      </Screen>
    );
  }
